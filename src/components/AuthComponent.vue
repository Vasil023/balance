  ...
  <main class="w-full h-screen flex flex-col items-center justify-center px-4">
    <div class="max-w-sm w-full text-gray-600">
      ...
      <form onsubmit="event.preventDefault()" class="mt-8 space-y-5">
        <div>
          <label class="font-medium dark:text-white"> Email </label>
          <input
            type="email"
            required
        ...
        <div>
          <label class="font-medium dark:text-white"> Password </label>
          <input
            type="password"
            required
            class="w-full mt-2 px-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg"
        ...
        <div class="text-center">
          <a href="javascript:void(0)" class="hover:text-indigo-600 dark:text-white">Forgot password?</a>
        </div>
      </form>
    </div>
  </main>
